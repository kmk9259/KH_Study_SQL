...
--사원 테이블에 새로운 데이터가 들어오면 신입사원이 입사하였습니다를 출력하기
...
VALUES
    (300, '유야호', '650212-151432', 'gil@kh.or.kr', '01012345567',
    'D5', 'J3', 'S5', 300000, 0.1, 200,SYSDATE, NULL, DEFAULT);
--제품이 입고될 때 마다 상품 재고 테이블의 수치를 관리자가 수동으로 관리하면 불편,
--이 때 트리거를 이용하면 재고가 입출고 시 자동으로 입력 되도록 할 수 있다.
...
INSERT INTO PRO_DETAIL VALUES (SEQ_DCODE.NEXTVAL, 1, SYSDATE,6,'출고');
